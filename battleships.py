...
def aiturn(board,ailast_cell,ailast_hit):
    ...
    if ailast_hit == 1:
        ...
        if ailast_direction == 1 or ailast_direction == -3:
            cell = [ailast_cell[0]+1,ailast_cell[1]]

        elif ailast_direction == 2 or ailast_direction == -4:
            cell = [ailast_cell[0],ailast_cell[1]+1]

        elif ailast_direction == 3 or ailast_direction == -1:
            cell = [ailast_cell[0]-1,ailast_cell[1]]

        elif ailast_direction == 4 or ailast_direction == -2:
            cell = [ailast_cell[0],ailast_cell[1]-1]
    ...
    try:
        if (board[cell[1]])[cell[0]] == "[■]": #if cell has boat marks with "[X]"
            ...
            ailast_cell = cell
            if ailast_direction > 0 and ailast_hit < 0:
                ailast_direction = -ailast_direction
                ailast_hit = 2

        elif (board[cell[1]])[cell[0]] == "[ ]": #if cell doesn't have a boat marks with "[/]"
            (board[cell[1]])[cell[0]] = "[/]"
            if ailast_direction > 0 and ailast_hit != 1:
                ailast_hit = -ailast_hit
            elif ailast_direction <= 0:
                ailast_hit = 0
                ailast_direction = 0

        elif ailast_direction > 0:
            ailast_direction = ailast_direction + 1
            try:
        ...
        elif ailast_direction > 0 and ailast_hit < 0:
            ailast_direction = 0
            ailast_hit = 0
